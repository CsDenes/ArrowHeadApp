//
//  CloudSystemTableViewController.swift
//  ArrowHead
//
...
class CloudSystemTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let uri = "https://152.66.245.169:8449/api/api/systems"
        
        Alamofire.request(.GET, uri) //parameters: ["foo": "bar"])
